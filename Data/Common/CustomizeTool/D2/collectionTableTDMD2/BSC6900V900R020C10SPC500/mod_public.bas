...
Public Function init(ByRef srcWB As Workbook)
    Dim i, j, col As Integer, row As Long
    Dim isChs As Boolean
    ...
    For i = 1 To srcWB.Sheets.Count
        If gShtName_bts = srcWB.Sheets(i).Name Then
            ...
            ' 英文 不带 *
            FindLocateFromSht srcWB.Sheets(i), "BTS Name", row, col
            ...
            ' 中文 不带 *
            FindLocateFromSht srcWB.Sheets(i), "基站名称", row, col
            If (0 < row) Or (0 < col) Then
                isChs = True
                Exit For
            End If
    ...
    ' 检测为中文
    If isChs Then
        gColName_btsName = "基站名称"
        gColName_btsType = "基站类型"
        gColName_cellName = "小区名称"
        gColName_cellName2 = "小区名称"
        gColName_cellType = "小区类型"
        gColName_bcch = "主B频点"
        gColName_noBcch = "非主B频点（通过半角逗号隔开）"
        gColName_fc = "频点分布信息"
        gColName_btsTpltName = "基站模板名称"
        
        gCaption_TemplateForm = "增加/删除基站模板"
        gCaption_Label1 = "基站类型"
        gCaption_Label2 = "模板名称"
        gCaption_OptionButton1 = "增加"
        gCaption_OptionButton2 = "删除"
        gCaption_SubmitAdd = "增加"
        gCaption_SubmitDelete = "删除"
        gCaption_CancelButton = "取消"
        gCaption_OKButton = "确定"
        
       gMsg_AddEmpty = "模板名称不能为空。"
       gMsg_AddExistH = "模板"
       gMsg_AddExistE = "已经存在。"
       gMsg_AddSuccH = "添加模板"
       gMsg_AddSuccE = "成功。"
       
       gMsg_DelEmpty = "请输入模板名称"
       gMsg_DelExistH = "模板"
       gMsg_DelExistE = "不存在。"
       gMsg_DelSuccH = "删除模板"
       gMsg_DelSuccE = "成功。"
       ...
       gCaption_BandTitle = "检查频段"
       gCaption_BandCheck = "检查"
       gCaption_BandCancel = "取消"
       
       gMsg_BandCheckPass = "检查通过。"
       gMsg_BandCheckError = "发现错误，请打开文件"
       
       gMsg_OperWarning = "提示"
       gMsg_OperInfo = "信息"
       
       gCaption_CustomizeTemplate = "定制场景"
       
       gCaptionCreateBTS = "建站"
       gCaptionRpsTDMInBSC = "BSC内TDM基站搬迁"
       gCaptionRpsBetweenBSC = "跨BSC基站搬迁"
       gCaptionAll = "不限定使用场景"
       gCaptionSceneFrame = "场景"
       
       ' 默认为英文
    Else
        gColName_btsName = "BTS Name"
        gColName_btsType = "BTS Type"
        gColName_cellName = "GSM Cell Name"
        gColName_cellName2 = "Cell Name"
        gColName_cellType = "Cell Type"
        gColName_bcch = "Frequency of BCCH"
        gColName_noBcch = "Non-Main BCCH Frequency List (Separated by "","")"
        gColName_fc = "Frequency Class"
        gColName_btsTpltName = "BTS Template Name"
        
        gCaption_TemplateForm = "Add/Delete BTS Template"
        gCaption_Label1 = "BTS Type"
        gCaption_Label2 = "Template Name"
        gCaption_OptionButton1 = "Add"
        gCaption_OptionButton2 = "Delete"
        gCaption_SubmitAdd = "Add"
        gCaption_SubmitDelete = "Delete"
        gCaption_CancelButton = "Cancel"
        gCaption_OKButton = "OK"
        
       gMsg_AddEmpty = "Template Name can not be empty."
       gMsg_AddExistH = "Template"
       gMsg_AddExistE = "already exists."
       gMsg_AddSuccH = "Add template"
       gMsg_AddSuccE = "succeed."
       
      gMsg_DelEmpty = "Please input Template Name"
      gMsg_DelExistH = "Template"
      gMsg_DelExistE = "does not exist."
      gMsg_DelSuccH = "Delete template"
      gMsg_DelSuccE = "succeed."
      
       gCaption_BandTitle = "Check frequency band"
       gCaption_BandCheck = "Check"
       gCaption_BandCancel = "Cancel"
       
       gMsg_BandCheckPass = "The check is passed."
       gMsg_BandCheckError = "Find error, please open file"
       
       gMsg_OperWarning = "Warning"
       gMsg_OperInfo = "Information"
       
       gCaption_CustomizeTemplate = "Customize Scene"
       
       gCaptionCreateBTS = "Create BTS"
       gCaptionRpsTDMInBSC = "Reparent TDM BTS Within BSC"
       gCaptionRpsBetweenBSC = "Reparent BTS Between BSCs"
       gCaptionAll = "All Scenes"
       gCaptionSceneFrame = "Scene"
...
Function isCustomizedTpl() As Boolean
    ...
    For row = 2 To MappingSiteTemplate.Range("a65536").End(xlUp).row
