...
Private Sub DeleteSite()
    ...
    '当前数据行数
    rowscount = Worksheets("MappingSiteTemplate").range("a65536").End(xlUp).row
...
Private Sub DeleteCell()
    ...
    '当前数据行数
    rowscount = Worksheets("MappingCellTemplate").range("a65536").End(xlUp).row
...
Private Sub DeleteRadio()
    ...
    '当前数据行数
    rowscount = Worksheets("MappingRadioTemplate").range("a65536").End(xlUp).row
