...
Public Sub IUPS_Ensure_NoValue(ByVal Target As Range)
...
Public Sub IUPS_RefreshThisSheet(ByVal Target As Range, isActivateFlag As Boolean)
    ...
    Call IUPS_Ensure_NoValue(Target)
