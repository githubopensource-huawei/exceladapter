...
Public Sub IUR_Ensure_NoValue(ByVal Target As Range)
...
Public Sub IUR_RefreshThisSheet(ByVal Target As Range, isActivateFlag As Boolean)
    ...
    Call IUR_Ensure_NoValue(Target)
