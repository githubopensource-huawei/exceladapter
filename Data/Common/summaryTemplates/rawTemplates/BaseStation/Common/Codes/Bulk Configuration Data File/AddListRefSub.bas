...
Sub iubTransportSheetSelectionChange(sheet As Worksheet, target As Range)
    Dim groupName As String
    Dim columnName As String
    Dim mappingDef As CMappingDef
    Dim address As String
...
Private Function getMappingDefByAddress(wb As Workbook, startPos As Long, column As Long, sheetName As String) As CMappingDef
    ...
    mocNameCol = innerPositionMgr.mappingDef_mocNameColNo
    attrNameCol = innerPositionMgr.mappingDef_attrNameColNo
    neTypeCol = innerPositionMgr.mappingDef_neTypeColNo
