...
Public Sub addLink4NormalShts()
    ...
    shtNameColNum = innerPositionMgr.mappingDef_shtNameColNo
    grpNameColNum = innerPositionMgr.mappingDef_grpNameColNo
    colNameColNum = innerPositionMgr.mappingDef_colNameColNo
    isRefColNum = innerPositionMgr.mappingDef_isRefColNo
