...
Public Sub addLink4NormalShts()
    ...
    For m_rowNum = 2 To mappingDef.range("a65536").End(xlUp).row
        ...
        If Get_DesStr(textValue) = Get_DesStr("TRUE") Then
            ...
            For n_RowNum = 3 To getUsedRowCount(ws)
                ...
                If Is_Ref(textValue, "\") Then
                    ...
                    If linkSheetName = getResByKey("CommonData") Then
...
Private Function getGroupNameFromMappingDef(sheetName As String, attributeName As String, Optional excludeGrpName As String) As String
    Dim mappingDef As Worksheet
...
Private Sub addRange(linktype As ClinkType, ctlDef As CControlDef)
            ...
            End If
            If linktype.linkSheetName = getResByKey("CommonData") Then
