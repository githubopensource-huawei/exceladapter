...
Private Sub initResources()
    ...
    Select Case getNeType
        ...
        Case NeType_DSA
            nodeNameColName = getResByKey("*DSAName")
        Case Else
            nodeNameColName = getResByKey("*Name")
    End Select
    ...
    ignoreShtNames.Add Item:=getResByKey("DCell"), key:=getResByKey("DCell")
    ignoreShtNames.Add Item:=getResByKey("DCellSectorEqm"), key:=getResByKey("DCellSectorEqm")
End Sub
