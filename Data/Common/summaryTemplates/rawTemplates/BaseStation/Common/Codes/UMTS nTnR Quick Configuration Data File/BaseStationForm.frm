...
Private Sub BaseStationNameBox_Click()
    Me.Caption = getResByKey("BaseStationName:")
End Sub
...
Private Sub UserForm_Activate()
    Me.Caption = getResByKey("selectSiteName")
    Me.OKButton.Caption = getResByKey("NextStep")
    Me.CancelButton.Caption = getResByKey("Cancel")
    Me.BaseStationNameBox.Caption = getResByKey("BaseStationName:")
End Sub
