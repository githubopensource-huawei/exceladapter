...
Private Sub DeleteCell()
    ...
    For m_rowNum = 2 To rowscount
        If MappingCellTemplate.Cells(m_rowNum, 5) = templatename _
                ...
                And (MappingCellTemplate.Cells(m_rowNum, 2) = TxRxMode.value Or Me.TxRxMode.Enabled = False) _
                And (MappingCellTemplate.Cells(m_rowNum, 1) = BandWidth.value Or Me.BandWidth.Enabled = False) Then
...
Private Sub AddCell()
    ...
    If existflg = 0 Then
        ...
        MappingCellTemplate.Cells(lastLineofGroup, 6).value = CellType
...
Private Sub SetCellPattern()
    ...
    For m_rowNum = 2 To MappingCellTemplate.Range("E1048576").End(xlUp).row
         If BandWidth = MappingCellTemplate.Cells(m_rowNum, 1).value And FddTddIdd = MappingCellTemplate.Cells(m_rowNum, 3).value And TxRxMode = MappingCellTemplate.Cells(m_rowNum, 2).value Or (Me.BandWidth.Enabled = False And Me.TxRxMode.Enabled = False And FddTddIdd = MappingCellTemplate.Cells(m_rowNum, 3).value) Then
