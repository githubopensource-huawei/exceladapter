VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} LampsiteMuliBtsFilterForm 
   Caption         =   "Select Base Station"
   ClientHeight    =   6705
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   12300
   OleObjectBlob   =   "LampsiteMuliBtsFilterForm.frx":0000
   StartUpPosition =   1  '所有者中心
End
Attribute VB_Name = "LampsiteMuliBtsFilterForm"
...
'    Call btsNameManager.setUnselectedMocFlag
    ...
    Call insertColAndWriteData(selectedMocCol, CellSheetName)
...
Private Sub UserForm_Initialize()
    ...
    Call initLampsiteBTSNameManager
