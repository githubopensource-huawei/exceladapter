...
Private Sub addCommentsBySheetType_Common(sht As Worksheet)
    ...
    With sht
        Do
            ...
            grpName = Trim(.Cells(grpRowIdx, 1).value)
...
Private Function getGrpName_List(sht As Worksheet, ByVal colIdx As Integer) As String
    On Error GoTo ErrorHandler
    Dim col As Integer
    getGrpName_List = ""
    For col = colIdx To 1 Step -1
        getGrpName_List = sht.Cells(1, col)
