...
Function isCellSheet(sheetName As String) As Boolean
    If sheetName = "GSM Cell" Or sheetName = "UMTS Cell" Or sheetName = "LTE Cell" _
        Or sheetName = "GSM小区" Or sheetName = "UMTS小区" Or sheetName = "LTE小区" Then
        isCellSheet = True
        Exit Function
    End If
    isCellSheet = False
...
Function isTrasnPortSheet(sheetName As String) As Boolean
    If sheetName = "GSM Cell" Or sheetName = "UMTS Cell" Or sheetName = "LTE Cell" _
        Or sheetName = "GSM小区" Or sheetName = "UMTS小区" Or sheetName = "LTE小区" _
        Or sheetName = "GTRXGROUP" Or sheetName = "TRX组" Then
