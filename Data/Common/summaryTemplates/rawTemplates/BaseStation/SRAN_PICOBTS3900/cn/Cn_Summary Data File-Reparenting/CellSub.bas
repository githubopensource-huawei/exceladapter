...
Public Function isCellExist() As Boolean
    ...
    Or IsSheetExist(getResByKey("NR Local Cell")) Or IsSheetExist(getResByKey("NR DU Cell")) _
    Or IsSheetExist(getResByKey("DCell")) Then
        isCellExist = True
    Else
         isCellExist = False
    End If
...
Public Function isCellSheet(sheetName As String) As Boolean
    ...
    Or sheetName = getResByKey("NR Local Cell") Or sheetName = getResByKey("NR DU Cell") _
    Or sheetName = getResByKey("NB-IoTCell") Or sheetName = getResByKey("DCell") Then
        isCellSheet = True
        Exit Function
    End If
    isCellSheet = False
...
Public Function isTransPortSheet(sheetName As String) As Boolean
    If isCellSheet(sheetName) Or sheetName = getResByKey("GTRXGROUP") Or sheetName = getResByKey("GTRX") _
    Or sheetName = getResByKey("NB-IoT TRX") _
    Or sheetName = getResByKey("NRDUCellTrp") Or sheetName = getResByKey("NRDUCellCoverage") _
