...
'    Call btsNameManager.setUnselectedMocFlag
    ...
    If isOperationExcel Then
        Call AddTrxBindsOperation(selectedMocCol, CellSheetName)
    Else
        Call AddTrxBinds(selectedMocCol, CellSheetName)
    End If
    Unload Me
End Sub
...
Private Sub initBaseStationScenario()
    ...
    For rowIndex = 3 To maxRow
        ...
        For sceIndex = LBound(scenarioColNumArr) To UBound(scenarioColNumArr)
            ...
            temGroupName = getRealGrpName(sheet, 1, scenarioColNumArr(), sceIndex)
