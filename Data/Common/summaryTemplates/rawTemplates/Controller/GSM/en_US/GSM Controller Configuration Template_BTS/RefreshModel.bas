...
Function is_DelColumnName(columnName As String) As Boolean
    ...
    ElseIf (columnName = getResByKey("A216")) Then
        is_DelColumnName = True
    ElseIf (columnName = "*BTS Name") Then
        is_DelColumnName = True
    ElseIf (columnName = getResByKey("A217")) Then
        is_DelColumnName = True
    ElseIf (columnName = "*Name") Then
        is_DelColumnName = True
    ElseIf (columnName = getResByKey("A218")) Then
        is_DelColumnName = True
    ElseIf (columnName = getResByKey("A219")) Then
         is_DelColumnName = True
