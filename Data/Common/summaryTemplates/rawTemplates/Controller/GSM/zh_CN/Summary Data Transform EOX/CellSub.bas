...
Function isCellSheet(sheetName As String) As Boolean
    If sheetName = "GSM Cell" Or sheetName = "UMTS Cell" Or sheetName = "LTE Cell" _
        Or sheetName = getResByKey("A170") Or sheetName = getResByKey("A171") Or sheetName = getResByKey("A172") Then
        isCellSheet = True
        Exit Function
    End If
    isCellSheet = False
...
Function isTrasnPortSheet(sheetName As String) As Boolean
    If sheetName = "GSM Cell" Or sheetName = "UMTS Cell" Or sheetName = "LTE Cell" _
        Or sheetName = getResByKey("A173") Or sheetName = getResByKey("A174") Or sheetName = getResByKey("A175") _
        Or sheetName = "GTRXGROUP" Or sheetName = getResByKey("A176") Then
...
Public Sub CellSelectionChange(ByVal sheet As Worksheet, ByVal Target As Range)
        'init 逻辑GCell
        Call initCellTemplate(sheet, Target, logicAttrName, logicCellMocName, "GSM")
