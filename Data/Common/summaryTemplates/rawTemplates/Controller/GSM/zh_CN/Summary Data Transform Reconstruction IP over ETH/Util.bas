...
Public Function WriteFile(ByVal strFileName As String, colWri As Collection, Optional bOverLay As Boolean = False, Optional bMarkSeq As Boolean = False) As Boolean
    ...
    If pos > 0 Then
        ...
        If Not NewDir(strPath) Then
            SysErr "File path" & vbCrLf & strPath & vbCrLf & getResByKey("A132")
            Exit Function
        End If
    End If
...
Public Sub ClosingProStatusbaring()
    Application.StatusBar = getResByKey("A133") '状态栏恢复正常
End Sub
...
Function is_Site(columnName As String) As Boolean
    is_Site = False
    If (columnName = "*NodeB Name" Or columnName = getResByKey("A151") Or _
        columnName = "*BTS Name" Or columnName = getResByKey("A152") Or _
        columnName = "*Name" Or columnName = getResByKey("A153") Or _
        columnName = "*eNodeB Name" Or columnName = getResByKey("A154") Or _
        columnName = "*USU Name" Or columnName = getResByKey("A155") Or _
        columnName = getResByKey("USU3900NAME") Or columnName = getResByKey("USU3910NAME") Or _
...
Function is_Controller(columnName As String) As Boolean
    is_Controller = False
    If (columnName = "*RNC Name" Or columnName = getResByKey("A156") Or _
        columnName = "*BSC Name" Or columnName = getResByKey("A157")) Then
        is_Controller = True
    End If
End Function
