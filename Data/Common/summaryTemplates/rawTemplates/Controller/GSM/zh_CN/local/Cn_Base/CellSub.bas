...
Function isCellSheet(sheetName As String) As Boolean
    If sheetName = "GSM Cell" Or sheetName = "UMTS Cell" Or sheetName = "LTE Cell" Or sheetName = "NB-IoT Cell" _
        Or sheetName = getResByKey("A91") Or sheetName = getResByKey("A92") Or sheetName = getResByKey("RFA Cell") Or sheetName = getResByKey("A93") Or sheetName = getResByKey("A100") Then
        isCellSheet = True
        Exit Function
    End If
    isCellSheet = False
...
Function isTrasnPortSheet(sheetName As String) As Boolean
    If sheetName = "GSM Cell" Or sheetName = "UMTS Cell" Or sheetName = "LTE Cell" Or sheetName = "NB-IoT Cell" _
        Or sheetName = getResByKey("A94") Or sheetName = getResByKey("A95") Or sheetName = getResByKey("RFA Cell") Or sheetName = getResByKey("A96") Or sheetName = getResByKey("A100") _
        Or sheetName = "GTRXGROUP" Or sheetName = getResByKey("A97") Then
...
Function isGsmCellSheet(sheetName As String) As Boolean
    If sheetName = "GSM Cell" Or sheetName = getResByKey("A98") Then
        isGsmCellSheet = True
        Exit Function
    End If
...
Function isLteCellSheet(ByRef sheetName As String) As Boolean
    If sheetName = "LTE Cell" Or sheetName = getResByKey("A99") Then
        isLteCellSheet = True
    Else
...
Function Get_LteCellTemplate_Related(DlBandwidth As String, TxRxMode As String, FDDTDD As String, SA As String, NBIoTFlag As String, sheet As Worksheet, cellRange As range, ByRef CellType As String) As String
    ...
    For m_rowNum = 2 To Worksheets("MappingCellTemplate").range("A1048576").End(xlUp).row
        ...
        And (TxRxMode = Worksheets("MappingCellTemplate").Cells(m_rowNum, 5).value Or TxRxMode = "" Or Worksheets("MappingCellTemplate").Cells(m_rowNum, 5).value = "") _
