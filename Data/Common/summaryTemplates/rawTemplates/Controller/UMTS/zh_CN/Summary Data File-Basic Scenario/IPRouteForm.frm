...
Private Sub OKButton_Click()
    ...
    For i = 3 To Worksheets("IPRouteMap").range("a1048576").End(xlUp).row
        ...
        If Worksheets("IPRouteMap").Cells(i, 1).value = getResByKey("A244") Then
            For dstIpRowEnd = 1 To Worksheets(getResByKey("A245")).range("a1048576").End(xlUp).row
        ...
        End If
         ...
         If Worksheets("IPRouteMap").Cells(i, 1).value = getResByKey("A244") Then
            For sourceMaskRowEnd = 1 To Worksheets(getResByKey("A245")).range("a1048576").End(xlUp).row
