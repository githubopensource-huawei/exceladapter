...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} BasebandEqmAdjustmentForm 
   Caption         =   "Adjust Baseband Equipment Board No."
   ClientHeight    =   6120
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   6465
...
Private Sub CurrentBoardNoListBox_Change()
    Dim eachListIndex As Long
    Me.DeleteCommandButton.Enabled = False
    With Me.CurrentBoardNoListBox
        For eachListIndex = 0 To .ListCount - 1
            If .Selected(eachListIndex) = True Then
                Me.DeleteCommandButton.Enabled = True
            End If
        Next eachListIndex
    End With
End Sub
...
Private Sub controlAddDeleteButtons()
    ...
    Else
        ...
        With Me.OptionalBoardNoListBox
            ...
            Next eachListIndex
        End With
        Me.AddAllCommandButton.Enabled = True
    End If
    ...
    Else
        ...
        With Me.CurrentBoardNoListBox
            ...
            Next eachListIndex
        End With
        Me.DeleteAllCommandButton.Enabled = True
    End If
End Sub
...
Private Sub OptionalBoardNoListBox_Change()
Dim eachListIndex As Long
    Me.AddCommandButton.Enabled = False
    With Me.OptionalBoardNoListBox
        For eachListIndex = 0 To .ListCount - 1
